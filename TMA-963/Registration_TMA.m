...
for row = 'A':'L'
    for col = 1:10
        ...
        centroids_folder = dir(sprintf('%s/TMA - Coordinates/IHC_Rescaled_Coords/%s', current_path, coreName));
        ...
        reg_dirPath = sprintf('%s/TMA - Coordinates/IHC_Registered_Coords/%s', pwd, coreName);
        mkdir(reg_dirPath)
        ...
        if(filenumber == 11)
            ...
            for flag = 0:8
                switch flag
                    case 0
                        coreType = 'CK56';
                        coords_toReg = load(sprintf('%s/TMA - Coordinates/IHC_Rescaled_Coords/%s/CK5-6.mat', current_path, coreName)).coords_toReg;
                    ...
                    case 1
                        ...
                        coords_toReg = load(sprintf('%s/TMA - Coordinates/IHC_Rescaled_Coords/%s/%s.mat', current_path, coreName, coreType)).coords_toReg;
                    ...
                    case 4
                        ...
                        coords_toReg = load(sprintf('%s/TMA - Coordinates/IHC_Rescaled_Coords/%s/Cyclin.mat', current_path, coreName)).coords_toReg;
                    ...
                    case 8
                        ...
                        coords_toReg = load(sprintf('%s/TMA - Coordinates/IHC_Rescaled_Coords/%s/GATA3.mat', current_path, coreName)).coords_toReg;
